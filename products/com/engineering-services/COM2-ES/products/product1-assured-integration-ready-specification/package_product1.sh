...
COM2_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd -P)"

PKG="F8TF_COM2_ASSURED_INTEGRATION_READY_SPECIFICATION_1.0.0"

EXPECTED_ARCHIVE_SHA256="657227c8ba270dfb516266720f46fc9c46fb0cf9fd9dfa8f0b81c539001822dd"

OUT_ROOT="${1:-$HOME/f8tf-com2-product1-release}"
...
BOM=(
  ...
  "specification/COM2_ODP_CORRESPONDENCE_SPECIFICATIONS.md"
...
echo "=== COM2 PRODUCT1 — DETERMINISTIC PACKAGING ==="
...
echo
echo "PASS: COM2 Product1 1.0.0 deterministic package"
